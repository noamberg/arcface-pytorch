...
class Dataset2(data.Dataset):
    ...
    def __init__(self, root, data_list_file ,input_shape=(1, 112, 112)):
        #self.phase = phase
        self.input_shape = input_shape
...
if __name__ == '__main__':
    dataset = Dataset(root=r'C:\Users\noamb\PycharmProjects\Volcani\arcface-pytorch\data\facebank',
                      data_list_file=r'C:\Users\noamb\PycharmProjects\Volcani\arcface-pytorch\data\facebank\test.txt',
                      phase='test',
